package com.qingtian.mylibrary.banner;
...
import com.qingtian.mylibrary.banner.transformer.BGAPageTransformer;
import com.qingtian.mylibrary.banner.transformer.TransitionEffect;
...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mPointContainerBackgroundDrawable = new ColorDrawable(Color.parseColor("#ff00ff"));
