 ...
 * 编写人：li
 * 功能描述： 没有完成 这是在底部弹出的list的选择
 */
public class CommonListPopupWindow extends  CommonPopupWindow{
     PopupController controller;

    private CommonListPopupWindow(Context context) {
        super(context);
    }
    ...
    public static class Builder {
         ...
         * @return
         */
        public CommonListPopupWindow create() {
            final CommonListPopupWindow popupWindow = new CommonListPopupWindow(params.mContext);
