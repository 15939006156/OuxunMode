...
//        popupWindow.showAtLocation(findViewById(android.R.id.content), Gravity.NO_GRAVITY, positions[0] - popupWindow.getWidth(), positions[1]);
    ...
    public void showAll(View view) {
        ...
        //测量View的宽高
        MySizeUtils.measureWidthAndHeight(upView);
        popupWindow = new CommonPopupWindow.Builder(this)
...
//        popupWindow.showAtLocation(findViewById(android.R.id.content), Gravity.NO_GRAVITY, positions[0], positions[1] - popupWindow.getHeight());
    ...
    public void showReminder(View view) {
        if (popupWindow != null && popupWindow.isShowing()) return;
        popupWindow = new CommonPopupWindow.Builder(this)
                .setView(R.layout.popindow_info)
                .setWidthAndHeight(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT)
                .create();
        popupWindow.showAsDropDown(view, (int) (-popupWindow.getWidth() + MyConvertUtils.dp2px(20f)), -(popupWindow.getHeight() + view.getMeasuredHeight()));
    }
    ...
    public void getChildView(View view, int layoutResId) {
        ...
        if (layoutResId == R.layout.popup_down) {
            ...
            mAdapter.setOnItemClickListener(new MypopwindowOnclickListener() {
                @Override
