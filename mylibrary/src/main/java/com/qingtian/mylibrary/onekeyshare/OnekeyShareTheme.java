 ...
 */
package com.qingtian.mylibrary.onekeyshare;
import com.qingtian.mylibrary.onekeyshare.themes.classic.ClassicTheme;
...
public enum OnekeyShareTheme {
	...
	private OnekeyShareTheme(int value, ClassicTheme impl) {
		this.value = value;
		this.impl = impl;
	}
