...
package com.qingtian.mylibrary.dialog.fragment;
...
import com.qingtian.mylibrary.dialog.listeren.INegativeButtonDialogListener;
import com.qingtian.mylibrary.dialog.listeren.INeutralButtonDialogListener;
import com.qingtian.mylibrary.dialog.listeren.IPositiveButtonDialogListener;
import com.qingtian.mylibrary.dialog.views.BaseDialogBuilder;
import java.util.List;


/**
 * 显示简单消息的对话框，带有标题或消息的标题和两个按钮的消息。activity或fragment 需要实现{ISimpleDialogListener }
 * 你的片段或活动的直接的确定和取消的按钮点击。这个类可以
 * 扩展更多的参数可重写build()加入方法。
 */
public class SimpleDialogFragment extends BaseDialogFragment {

    protected final static String ARG_MESSAGE = "message";
    protected final static String ARG_TITLE = "title";
    protected final static String ARG_POSITIVE_BUTTON = "positive_button";//确定按钮
    protected final static String ARG_NEGATIVE_BUTTON = "negative_button";//取消
