...
public class RSA {
	...
	public static String sign(String text, String privateKey, String charset) throws Exception {
		...
		byte[] keyBytes = ThreeDes.Base64.decode(privateKey);
		...
		return ThreeDes.Base64.encode(result);
	...
	public static boolean verify(String text, String sign, String publicKey, String charset) throws Exception {
		byte[] keyBytes = ThreeDes.Base64.decode(publicKey);
		...
		signature.update(getContentBytes(text, charset));
		return signature.verify(ThreeDes.Base64.decode(sign));
	...
	public static String getPrivateKey(Map<String, Object> keyMap) throws Exception {
		...
		return ThreeDes.Base64.encode(key.getEncoded());
	}
